...
std::optional<std::string> Request::parse_request_line(std::string_view bufView)
{
     /* 只取第一行 */
...
std::optional<fs::path> Request::parse_request_path(std::optional<std::string> path)
{
     if (!path.has_value()) {
